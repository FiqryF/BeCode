            ...
            <div class="mx-auto max-w-screen-xl px-4 py-8 sm:px-6 sm:py-12 lg:px-8">
              <header class="text-center">
                ...
                <p class="mx-auto mt-4 max-w-md text-gray-500">
                  Cari produk yang relevan dengan anda
                </p>
              </header>
              ...
              @foreach($barang as $a)
                ...
                <li>
                  <a href="GC1.html" class="group block overflow-hidden">
                  <img src="{{ asset('storage/' . $a->gambar) }}" alt="Gambar" class="h-[350px] w-full object-cover transition duration-500 group-hover:scale-105 sm:h-[290px]">
                    ...
                    <div class="relative bg-white pt-3">
                      ...
                      <p class="mt-2">
                        ...
                        <span class="tracking-wider text-gray-900">{{ $a->harga }}</span>
                      </p>
                    </div>
                  </a>
                </li>
